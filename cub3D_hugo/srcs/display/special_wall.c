...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/17 13:23:21 by hde-min           #+#    #+#             */
/*   Updated: 2023/01/17 13:23:22 by hde-min          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3D.h"

int	ft_specal_wall_2(t_data *data, t_add *add, int dir, double xt)
{
	if (dir == 3)
	{
		if (xt > 0.01)
...
int	ft_special_wall(t_data *data, t_add *add, t_texture *t)
{
	...
	if (dir == 9)
	{
		...
		color = ft_specal_wall_2(data, add, dir, xt);
	return (color);
}
