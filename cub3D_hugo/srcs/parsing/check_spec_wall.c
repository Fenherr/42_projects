...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/16 11:24:59 by ngrenoux          #+#    #+#             */
/*   Updated: 2023/01/16 12:49:53 by ngrenoux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3D.h"

void	ft_check_spec_high_len(t_data *d, int i, int j)
{
...
void	ft_check_spec(t_data *d, int i, int j)
{
	if (d->dup_map[i - 1][j] == '0' && d->dup_map[i + 1][j] == '0'
		&& d->dup_map[i][j - 1] != '0' && d->dup_map[i][j + 1] != '0')
		d->dup_map[i][j] = '8';
