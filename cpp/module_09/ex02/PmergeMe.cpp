...
/*   Updated: 2023/04/20 11:44:35 by ngrenoux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PmergeMe::execute()
{
	...
	//Time display
	std::cout << "Time to process a range of " << _queueArray.size() << " elements with std::queue : " << std::fixed << queueTime << " sec" << std::endl;
