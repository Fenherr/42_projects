...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/08 13:35:34 by ngrenoux          #+#    #+#             */
/*   Updated: 2023/02/08 13:47:58 by ngrenoux         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3D.h"

static int	ft_corner_high_len(t_data *data, int i, int j)
{
	int	count;
...
static int	ft_corner_util(t_data *data, int i, int j)
{
	int	count;
...
static void	ft_corner(t_data *data, int i, int j, int index)
{
	int	count;
